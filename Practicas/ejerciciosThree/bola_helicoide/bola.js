class Bola extends THREE.Object3D{
  constructor(gui,titleGui){
    ...
    this.bola_helicoide = new THREE.Mesh(geom_bola, mat_bola);
    this.bola = new THREE.Object3D();

    this.cilindro.position.y = 6;
    this.bola_helicoide.position.set(5, 1.5, 0);

    this.add(this.cilindro);
    this.bola.add(this.bola_helicoide);
    this.add(this.bola);
  }
  ...
  update(){
    ...
    if(!this.guiControls.lim_sup){
      this.guiControls.posicion_bola_y += 0.01;
    ...
    this.bola_helicoide.position.set(this.guiControls.radio_cil, this.guiControls.posicion_bola_y, 0);
