...
class MyScene extends THREE.Scene {
  constructor(myCanvas) {
    ...
    // Ejes para la línea del peón
    this.ejes_linea = new THREE.AxesHelper(5);
    this.ejes_linea.position.x = 10;
    this.add(this.ejes_linea);
    ...
    this.linea_peon = this.model.getLinea();
    // Altura del peón, en el archivo del peón está calculada correctamente xD
    this.linea_peon.position.y = 1.4;
    this.ejes_linea.add(this.linea_peon);
  }
